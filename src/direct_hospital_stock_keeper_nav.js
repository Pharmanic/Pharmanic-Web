export default {
  items: [
    {
      name: 'Dashboard',
      url: '/direct_hospital_stock_keeper',
...

     {
          ...
          url: '/direct_hospital_stock_keeper/ministry_stores/ministry_stores_list',
          icon: 'icon-list',
        },
          {
          name: 'RDHS List',
          url: '/direct_hospital_stock_keeper/rdhss/rdhs_list',
          icon: 'icon-list',
        },
        {
          name: 'RDHS Hospital List',
          url: '/direct_hospital_stock_keeper/hospital_by_rdhs/hospital_by_rdhs_list',
          icon: 'icon-list',
        },
         {
          name: 'Direct Hospitals',
          url: '/direct_hospital_stock_keeper/direct_hospitals/direct_hospitals',
          icon: 'icon-list',
        },
