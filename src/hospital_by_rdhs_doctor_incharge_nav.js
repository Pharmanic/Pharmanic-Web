export default {
  items: [
    {
      name: 'Dashboard',
      url: '/hospital_by_rdhs_doctor_incharge',
...

     {
          ...
          url: '/hospital_by_rdhs_doctor_incharge/ministry_stores/ministry_stores_list',
          icon: 'icon-list',
        },
          {
          name: 'RDHS List',
          url: '/hospital_by_rdhs_doctor_incharge/rdhss/rdhs_list',
          icon: 'icon-list',
        },
        {
          name: 'RDHS Hospital List',
          url: '/hospital_by_rdhs_doctor_incharge/hospital_by_rdhs/hospital_by_rdhs_list',
          icon: 'icon-list',
        },
         {
          name: 'Direct Hospitals',
          url: '/hospital_by_rdhs_doctor_incharge/direct_hospitals/direct_hospitals',
          icon: 'icon-list',
        },
