  ...
  items: [
    {
...

     {
          ...
          url: '/rdhs_stock_keeper/ministry_stores/ministry_stores_list',
          icon: 'icon-list',
        },
          {
          name: 'RDHS List',
          url: '/rdhs_stock_keeper/rdhss/rdhs_list',
          icon: 'icon-list',
        },
        {
          name: 'RDHS Hospital List',
          url: '/rdhs_stock_keeper/hospital_by_rdhs/hospital_by_rdhs_list',
          icon: 'icon-list',
        },
         {
          name: 'Direct Hospitals',
          url: '/rdhs_stock_keeper/direct_hospitals/direct_hospitals',
          icon: 'icon-list',
        },
