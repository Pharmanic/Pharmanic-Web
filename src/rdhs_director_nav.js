  ...
  items: [
    {
...

     {
          ...
          url: '/rdhs_director/ministry_stores/ministry_stores_list',
          icon: 'icon-list',
        },
          {
          name: 'RDHS List',
          url: '/rdhs_director/rdhss/rdhs_list',
          icon: 'icon-list',
        },
        {
          name: 'RDHS Hospital List',
          url: '/rdhs_director/hospital_by_rdhs/hospital_by_rdhs_list',
          icon: 'icon-list',
        },
         {
          name: 'Direct Hospitals',
          url: '/rdhs_director/direct_hospitals/direct_hospitals',
          icon: 'icon-list',
        },
