...
class DashboardMinistryStockKeeper extends Component {
          ...
          <Col>
            <Card>
              <CardBody>
                <Row>
                  <Col sm="5">
                    <CardTitle className="mb-0">Daily Stock Variations - Ministry Stores (Total)</CardTitle>
          ...
          <Col>
            <Card>
              <CardBody>
                <Row>
                  <Col sm="6">
                    <CardTitle className="mb-0">Daily Stock Variations - Ministry Stores</CardTitle>
                    {/*<div className="small text-muted">November 2015</div>*/}
                  </Col>
                  
                </Row>
                <div className="chart-wrapper" style={{ height: 300 + 'px', marginTop: 40 + 'px' }}>
                  <Line data={mainChart1_} options={mainChart1_Opts} height={300} />
                </div>
              </CardBody>
              {/*<CardFooter>
                <Row className="text-center">
...
<Col sm="6">
        ...
        <Card>
            <CardHeader>
              Ministry Stores - Supply Variation
              <div className="card-header-actions">
                <a href="http://www.chartjs.org" className="card-header-action">
                  <small className="text-muted">docs</small>
                </a>
...
export default DashboardMinistryStockKeeper;
