              ...
              <CardBody>
                <Form onSubmit={this.handleSubmit} method="post" encType="multipart/form-data" className="form-horizontal">
                  ...
                  <FormGroup row>
                    ...
                    <Col xs="12" md="9">
                      <Input type="text" id="location" name="location" placeholder="Location" value={item.location || ''}
                    ...
                    <Col xs="12" md="9">
                      <Input type="text" id="total_storage" name="total_storage" placeholder="Total Storage" value={item.total_storage || ''}
                  ...
                  <FormGroup row>
                    ...
                    <Col xs="12" md="9">
                      <Input type="text" id="available_storage" name="available_storage" placeholder="Available Storage" value={item.available_storage || ''}
