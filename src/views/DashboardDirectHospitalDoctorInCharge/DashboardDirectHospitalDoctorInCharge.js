...
class DashboardDirectHospitalDoctorInCharge extends Component {
  constructor(props) {
    super(props);
            ...
            <Card>
              <CardBody>
                <Row>
                  <Col sm="5">
                    ...
                    <div className="small text-muted">Flowers</div>
                  </Col>
              ...
              <CardFooter>
                <Row className="text-center">
                  ...
                  <Col sm={12} md className="mb-sm-2 mb-0">
                    <div className="text-muted">Hy</div>
...
export default DashboardDirectHospitalDoctorInCharge;
