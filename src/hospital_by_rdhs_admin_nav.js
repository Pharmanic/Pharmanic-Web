  ...
  items: [
    {
...

     {
          ...
          url: '/hospital_by_rdhs_admin/ministry_stores/ministry_stores_list',
          icon: 'icon-list',
        },
          {
          name: 'RDHS List',
          url: '/hospital_by_rdhs_admin/rdhss/rdhs_list',
          icon: 'icon-list',
        },
        {
          name: 'RDHS Hospital List',
          url: '/hospital_by_rdhs_admin/hospital_by_rdhs/hospital_by_rdhs_list',
          icon: 'icon-list',
        },
         {
          name: 'Direct Hospitals',
          url: '/hospital_by_rdhs_admin/direct_hospitals/direct_hospitals',
          icon: 'icon-list',
        },
