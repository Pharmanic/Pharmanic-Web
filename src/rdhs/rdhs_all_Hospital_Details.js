  ...
  return (
    <div className="animated fadeIn">
          ...
          <Row>
             ...
             <Col>
               <InputGroup>
                 ...
                 <Input type="test" id="batchNo" name="batchNo" list="datalist1"  onChange={this.updateSearch.bind(this)} placeholder="Search by Hospital Name"> </Input>
      ...
      <Table className="mt-4">
                    <thead style={{ backgroundColor: '#D545EA', color: 'white', borderRadius: '5px',font:'1500px'}}>
                        <tr>
                            <th width="20%">Hospital name</th>
                            <th width="10%">Reg_no</th>
                            <th width="20%">Address</th>
                            <th width="10%">Email</th>
                            <th width="10%">Doctor Incharge</th>
